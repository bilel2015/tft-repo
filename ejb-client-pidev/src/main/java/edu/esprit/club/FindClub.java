...
public class FindClub extends JFrame {
	...
	public FindClub() {
		...
		panel_1 = new JPanel();
		panel_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Update & Delete Club", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		table.setModel(new DefaultTableModel(
				...
				new String[] {
						"id Club","Name Club","Number of player","year founded","Address"
				}
				));
